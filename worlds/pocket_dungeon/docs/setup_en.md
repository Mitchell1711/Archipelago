...
Note: you should not put it inside if the folder with your steamID, it needs to be this folder. In some cases there may be an existing savefile, the Archipelago client will back this savefile up as the file "saveBackup".
