...
The game should open in offline mode, this is indicated by red text on the title screen that says "Steam not logged in", this Archipelago implementation won't work outside of offline mode. If your game doesn't open in offline mode you'll have to go into the game directory folder and disable the files "steam_api64.dll" and "Steamworks_x64.dll" by renaming them.
